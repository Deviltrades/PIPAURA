-- ============================================================================
-- SIMPLE MIGRATION: Create Trade Accounts (Manual Setup Required)
-- ============================================================================

-- Create the trade_accounts table
...
-- Add account_id to trades (nullable for now - we'll fix this after you create an account)
...
-- 2. Go to /accounts page in your app
-- 3. Click "Add Account" and create your first trading account
-- 4. Then come back here and run the linking script below
-- ============================================================================

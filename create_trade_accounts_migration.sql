-- ============================================================================
-- MIGRATION: Add Trading Accounts System
-- ============================================================================
-- This script safely migrates existing trades to the new account system
...
-- ============================================================================
-- This ensures all existing trades can be linked to an account
...
-- STEP 4: Add account_id column (nullable first for migration)
-- ============================================================================
ALTER TABLE trades 
ADD COLUMN IF NOT EXISTS account_id UUID REFERENCES trade_accounts(id) ON DELETE RESTRICT;
...
-- ✅ Linked all existing trades to their user's legacy account
-- ✅ Set account_id as required (NOT NULL) for all future trades
-- 
-- Next steps:
-- 1. View your accounts at /accounts page

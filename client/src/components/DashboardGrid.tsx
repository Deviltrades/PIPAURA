...
export default function DashboardGrid({ analytics, trades, selectedAccount }: DashboardGridProps) {
  ...
  const defaultLayouts = {
    lg: [
      ...
      { i: "streak", x: 0, y: 22, w: 3, h: 4 },
      { i: "holdtime", x: 3, y: 22, w: 3, h: 5 },
      { i: "mostprofitable", x: 6, y: 22, w: 3, h: 4 },
      { i: "monthlyprogress", x: 9, y: 22, w: 3, h: 4 },
      { i: "firstlast", x: 0, y: 26, w: 6, h: 5 },
      { i: "setupbreakdown", x: 6, y: 26, w: 6, h: 6 },
      { i: "riskdeviation", x: 0, y: 31, w: 3, h: 4 },
      { i: "exposure", x: 3, y: 31, w: 3, h: 5 },
    ],
    md: [
      { i: "profit", x: 0, y: 0, w: 2, h: 2 },
      { i: "winrate", x: 2, y: 0, w: 2, h: 2 },
      ...
      { i: "streak", x: 0, y: 30, w: 3, h: 4 },
      { i: "holdtime", x: 3, y: 30, w: 3, h: 5 },
      { i: "mostprofitable", x: 0, y: 34, w: 3, h: 4 },
      { i: "monthlyprogress", x: 3, y: 34, w: 3, h: 4 },
      { i: "firstlast", x: 0, y: 38, w: 6, h: 5 },
      { i: "setupbreakdown", x: 0, y: 43, w: 6, h: 6 },
      { i: "riskdeviation", x: 0, y: 49, w: 3, h: 4 },
      { i: "exposure", x: 3, y: 49, w: 3, h: 5 },
    ],
    sm: [
      { i: "profit", x: 0, y: 0, w: 2, h: 2 },
      { i: "winrate", x: 2, y: 0, w: 2, h: 2 },
      ...
      { i: "streak", x: 0, y: 36, w: 2, h: 4 },
      { i: "holdtime", x: 2, y: 36, w: 2, h: 5 },
      { i: "mostprofitable", x: 0, y: 40, w: 2, h: 4 },
      { i: "monthlyprogress", x: 2, y: 40, w: 2, h: 4 },
      { i: "firstlast", x: 0, y: 44, w: 4, h: 5 },
      { i: "setupbreakdown", x: 0, y: 49, w: 4, h: 6 },
      { i: "riskdeviation", x: 0, y: 55, w: 2, h: 4 },
      { i: "exposure", x: 2, y: 55, w: 2, h: 5 },
    ],
    xs: [
      { i: "profit", x: 0, y: 0, w: 2, h: 2 },
      ...
      { i: "streak", x: 0, y: 42, w: 2, h: 4 },
      { i: "holdtime", x: 0, y: 46, w: 2, h: 5 },
      { i: "mostprofitable", x: 0, y: 51, w: 2, h: 4 },
      { i: "monthlyprogress", x: 0, y: 55, w: 2, h: 4 },
      { i: "firstlast", x: 0, y: 59, w: 2, h: 5 },
      { i: "setupbreakdown", x: 0, y: 64, w: 2, h: 6 },
      { i: "riskdeviation", x: 0, y: 70, w: 2, h: 4 },
      { i: "exposure", x: 0, y: 74, w: 2, h: 5 },
    ],
    xxs: [
      { i: "profit", x: 0, y: 0, w: 2, h: 2 },
      { i: "winrate", x: 0, y: 2, w: 2, h: 2 },

...
export default function DashboardGrid({ analytics, trades, selectedAccount }: DashboardGridProps) {
  ...
  const defaultLayouts = {
    lg: [
      ...
      { i: "streak", x: 0, y: 22, w: 3, h: 5 },
      { i: "holdtime", x: 3, y: 22, w: 3, h: 6 },
    ...
    md: [
      ...
      { i: "streak", x: 0, y: 30, w: 3, h: 5 },
      { i: "holdtime", x: 3, y: 30, w: 3, h: 6 },
    ...
    sm: [
      ...
      { i: "streak", x: 0, y: 36, w: 2, h: 5 },
      { i: "holdtime", x: 2, y: 36, w: 2, h: 6 },
    ...
    xs: [
      ...
      { i: "streak", x: 0, y: 42, w: 2, h: 5 },
      { i: "holdtime", x: 0, y: 47, w: 2, h: 6 },

...
export default function Pricing() {
  ...
  const litePlan = {
    ...
    features: [
      ...
      "Advanced analytics & Trader DNA™",
      "Institutional Fundamental Scorecards",
      "Prop firm challenge tracker",
      "Full tax reporting system",
      "AI Trading Mentor access",
      "Email support"
    ],
    popular: false,
    cta: "Start Lite"
  ...
  const plans = [
    {
      ...
      icon: TrendingUp,
      features: [
        "Can add up to 10 accounts",
        "2GB of secure data storage",
        "Unlimited trade logging",
        "Advanced analytics & Trader DNA™",
        "Institutional Fundamental Scorecards",
        "Prop firm challenge tracker",

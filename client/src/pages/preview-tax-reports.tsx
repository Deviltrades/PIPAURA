  ...
  return (
    <div className="p-3 sm:p-4 lg:p-8 min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 sm:mb-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white" data-testid="text-tax-title">Tax Reports</h1>
          <p className="text-sm sm:text-base text-gray-300">Generate comprehensive tax reports for your trading activity</p>
        </div>

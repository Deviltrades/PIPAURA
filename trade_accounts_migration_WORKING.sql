-- ============================================================================
-- MIGRATION: Add Trading Accounts System (EXPLICIT CASTS EVERYWHERE)
-- ============================================================================
-- Force all comparisons to TEXT to avoid any type inference issues
-- ============================================================================
...
-- RLS with EXPLICIT TEXT CASTS on both sides of comparison
...
-- ✅ RLS uses explicit TEXT casts to avoid type inference issues
-- ✅ Created "Legacy Account" for you with all existing trades  
